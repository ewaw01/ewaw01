...
Я backend-разработчик на Java. Изучаю язык второй год, до этого пробовал другие языки.  
...
**Backend:**
- Java 21, Spring Boot, Spring Security, JWT, Spring Data JPA, Spring Web MVC
